...
sudo cp "${SCRIPT_DIR}/verify-waveshare-10in85.py" "${INSTALL_DIR}/verify-waveshare-10in85.py"
...
sudo cp "${SCRIPT_DIR}/ad-eink-display.defaults" "${INSTALL_DIR}/ad-eink-display.defaults"
...
sudo chmod +x "${INSTALL_DIR}/verify-waveshare-10in85.py"
